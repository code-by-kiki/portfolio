...
function Resumedatas() {   
  ...
  const database=[{name:'My SQL',icon:<i class="bi bi-filetype-sql" id="icons"></i>},{name:'MangoDB',icon:<i class="bi bi-leaf"id="icons"></i>}]

  const tool=[{name:'Git-Hub',icon:<i class="bi bi-github" id="icons"></i>}] 

  const skill=[{name: "Communication"},{name:"problem solving"},{name:"Adaptability"}]

  return (
    <div className="container-fluid px-3 px-md-5" style={{ fontFamily: 'serif' }}>
      <div className="row mt-5" style={{ background: "rgb(68, 68, 78)", padding: '10px' }}></div>

      <div className="row">
        {/* Left Column */}
        <div className="col-12 col-md-6 col-sm-12 mt-3 text-md-start text-center">
          <img src={picture} alt="Krithika Profile" className="img-fluid d-none d-sm-block" style={{ maxWidth: '150px', borderRadius: '25rem' }} />
        ...
        {/* Right Column */}
        <div className="col-12 col-md-6 col-sm-12 text-start">
