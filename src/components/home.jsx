...
const Introduction = () => {
  return (
    <div>
      <body style={{ backgroundColor: '#e3e6e5', minHeight: '100vh', padding: '4rem 0' }}></body>
      <div className="container">
       <div className="row justify-content-center align-items-center">
  <div className="col-sm-12 col-md-12 col-lg-6 text-center animate__animated animate__fadeInLeft mb-4 mb-md-0">
    <img
      src={picture}
  ...
  <div className="col-12 col-md-12 col-lg-6  sm-mt-5 animate__animated animate__fadeInLeft px-3">
    ...
    <div className="p-2 col-sm-12" >
      <p className="fs-5  " style={{ textIndent: '2em', lineHeight: '1.5',textAlign:'justify' }}>
